                ...
                {!enviado ? (
                    <>
                        <div className="modal-reserva-header">
                            ...
                            <h2 className="modal-reserva-titulo">Agendar Consulta</h2>
                            <div className="modal-reserva-atencion">
                                <div className="modal-reserva-avatar">
                                    <img src="/Logo Jesus Gonzalez.png" alt="Jesús González" />
                                    <span className="modal-reserva-online"></span>
                                </div>
                                <div className="modal-reserva-info">
                                    <p className="modal-reserva-label-atencion">Atención al cliente</p>
                                    <p className="modal-reserva-nombre-atencion">Jesús González</p>
                                    <p className="modal-reserva-estado">● Online</p>
                                </div>
                            </div>
                        </div>
