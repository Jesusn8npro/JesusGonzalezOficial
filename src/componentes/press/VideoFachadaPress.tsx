...
/**
 * Fachada click-to-load de YouTube para el EPK: cero JS de terceros en
 * la carga inicial y sin autoplay no deseado. El iframe (con autoplay)
 * solo se inserta tras la acción explícita del usuario.
 */
const VideoFachadaPress: React.FC<Props> = ({ videoId, titulo }) => {
...
export default VideoFachadaPress;
